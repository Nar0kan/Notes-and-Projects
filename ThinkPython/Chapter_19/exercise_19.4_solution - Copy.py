    ...
    def on_drop(self, event):
        ...
        try:
            if ".!canvas" == target.__str__():
                ...
                self.widget.pack()
                self.add_dragable(self, self.widget, self.image, self.images)
        except:
            self.widget.pack()
            self.add_dragable(self.image_viewer, self.widget, self.image, self.images)
...
class ImageViewer():
    ...
    def load_images_pages(self) -> None:
        ...
        self.image_canvas = Canvas(self.frame, width=500, height=500, bg='#666666', bd=2, scrollregion=(0,0,500,800))
    ...
    def show_elements(self) -> None:
        """
            ...
            to interact with.
        """
        self.dir_label = Label(self.root, text='Current directory: ' + self.directory, font=('Arial', 10))
        ...
        self.open_image = Button(self.root, text='Random image', font=('Arial', 12), command=lambda:\
                                self.make_image(self.images[randint(0, len(self.images)-1)]))
        ...
        self.dir_label.grid(column=1, row=2)
    ...
    def change_dir(self) -> None:
        ...
        self.frame = Frame(self.root, width=500,height=500)
        self.frame.grid(column=3, row=2)
        self.image_canvas = Canvas(self.frame, width=500,height=500, bg='white', bd=2, scrollregion=(0,0,500,800))
    ...
    def next_page(self) -> None:
        ...
        if self.amount_of_pages > self.page_num:
            self.page_num += 1
            self.current_page = self.pages[self.page_num]
        elif self.amount_of_pages == self.page_num:
