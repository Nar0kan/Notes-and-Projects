# This approach sucks and not explained in neither the book not the code, 
# which is written like a shit btw, like importing in exercise files is
# dumb idea. So I will say, that the approach I used before sucks at perfomance
# but at least is working and the code is pretty clean and solid.
# BTW didn't understand how the random number will corespond with chances and
# values in the cumulative sum list, and how the binary search should be implemented
# if there is no such element inside... Bad written task = poor approach...
