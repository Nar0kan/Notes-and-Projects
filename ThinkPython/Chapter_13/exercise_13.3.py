...
def main() -> None:
    ...
    most_used_items = take(20, dict(sorted(words_dictionary.items(), key=lambda item: item[1], reverse=True)).items())
    print("Most frequently-used words in the book: \n")
    for item in most_used_items:
        print("Word '", item[0], "' is used ", item[1], " times.")
